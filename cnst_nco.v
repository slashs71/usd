...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="nco" LPM_CVALUE=1FFBE76D LPM_WIDTH=32 result
...
module  cnst_nco_lpm_constant_q6b
	( 
	result) ;
	output   [31:0]  result;
	...
	defparam
		mgl_prim1.cvalue = 32'b00011111111110111110011101101101,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1852010240,
...
endmodule //cnst_nco_lpm_constant_q6b
//VALID FILE
...
module cnst_nco (
	...
	cnst_nco_lpm_constant_q6b	cnst_nco_lpm_constant_q6b_component (
				.result (sub_wire0));
